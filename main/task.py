from main import PerceptualDecisionMaking, PerceptualDecisionMakingDelayResponse
...
class AntiPerceptualDecisionMakingDelayResponse(PerceptualDecisionMakingDelayResponse):
    """Only change groundtruth to anti-response"""
    def __init__(self, dt=100, **kwargs):
        super().__init__(dt=dt, **kwargs)
